...
import {URL, URL_IDTIMEFINISH, URL_TIMEFINISH} from "../components/const";
...
export default class InterpreterTimeFinish extends Component{
                                ...
                                <View style={styles.container}>
                                    ...
                                    <View style = {styles.container2}>
                                        ...
                                        <View style={{flexDirection:'row'}}>
                                            <Text style={{fontSize: sizeText2,flex:2, color: 'black'}}>{this.mTime(item.timeOfService)}</Text>
