...
export default class ViewMap extends Component {
    ...
    constructor(props) {
        ...
        console.log("lo", this.props.navigation.state.params.lo)
    }
    ...
    componentWillMount() {
     ...
     getPosition() {
         ...
         console.log('state', this.state.hoAddress.homeAddress.streetAddress)
         Geocoder.getFromLocation(this.state.hoAddress.homeAddress.streetAddress+","+this.state.hoAddress.homeAddress.city+","+this.state.hoAddress.homeAddress.noiState.name).then(
             json => {
     ...
     getPlaces(){
         console.log(this.props.navigation.state.params.lo)
         Geocoder.setApiKey('AIzaSyDjiRQgNIhJkh46enu19J8s8xQO0Y-nRzs'); // use a valid API key
